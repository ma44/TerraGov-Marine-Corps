...
/datum/ai_node
	...
	var/list/construction_markers = list(XENOMORPH = list(), MARINE = list(), NOTHING = list()) //ALL markers
	var/list/unassigned_markers = list(XENOMORPH = list(), MARINE = list(), NOTHING = list()) //All markers with no builder assigned
